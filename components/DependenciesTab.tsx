...
import { FileCode, Box, Package } from "lucide-react";
    ...
    return (
        <div className="p-6 animate-in fade-in duration-300">
            {dependencyEntries.length === 0 ? (
                <EmptyState
                    title="No supported dependencies found"
                    description="We found dependency files but couldn't parse any supported dependencies. Try running a scan to see if we can detect more details."
                    icon={Package}
                    onScan={onScan}
